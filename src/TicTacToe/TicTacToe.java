...
class SquareSkin extends StackPane {
  static final Image noughtImage = new Image(
      "https://icons.iconarchive.com/icons/double-j-design/ravenna-3d/96/Accept-icon.png"
  );
  static final Image crossImage = new Image(
      "https://icons.iconarchive.com/icons/icojam/blue-bits/96/symbol-delete-icon.png"
  );
